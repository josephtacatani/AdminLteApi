...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=934820404ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dental_app&table=schedules">`dental_app`.`schedules`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auth_api&table=RevokedTokens">`auth_api`.`RevokedTokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auth_api&table=users">`auth_api`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agency&table=wp_users">`agency`.`wp_users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3f3d632c60747a42354a27627d407669">
